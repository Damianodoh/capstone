...
With any market good, consumers at some point, are in a state of considering whether or not to purchase a good. In this state they could be called “considerers” of the good, if they purchase the good they transition from “considerers” to “adopters”. Using this terminology, I would to explore which households choose to adopt roof top solar, and what factors play a role in moving them from the considerer state to the adopter state. 
